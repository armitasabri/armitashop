			...
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
						...
						<a href="{{route('singleproduct')}}">Product Details</a>
					</div>
				</div>
			</div>
		</div>
						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							<ol class="carousel-indicators">
								<li data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
									<img src="{{asset ('app-assets/img/product/single-product/s-product-s-2.jpg')}}" alt="">
								</li>
								<li data-target="#carouselExampleIndicators" data-slide-to="1">
									<img src="{{asset ('app-assets/img/product/single-product/s-product-s-3.jpg')}}" alt="">
								</li>
								<li data-target="#carouselExampleIndicators" data-slide-to="2">
									<img src="{{asset ('app-assets/img/product/single-product/s-product-s-4.jpg')}}" alt="">
								</li>
							</ol>
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="{{asset ('app-assets/img/product/single-product/s-product-1.jpg')}}" alt="First slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="{{asset ('app-assets/img/product/single-product/s-product-1.jpg')}}" alt="Second slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="{{asset ('app-assets/img/product/single-product/s-product-1.jpg')}}" alt="Third slide">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-6">
							<div class="comment_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="{{asset ('app-assets/img/product/single-product/review-1.png')}}" alt="">
										</div>
								...
								<div class="review_item reply">
									<div class="media">
										<div class="d-flex">
											<img src="{{asset ('app-assets/img/product/single-product/review-2.png')}}" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2017 at 05:56 pm</h5>
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="{{asset ('app-assets/img/product/single-product/review-3.png')}}" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2017 at 05:56 pm</h5>
