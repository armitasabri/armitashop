...
<body>
    ...
    <form method="POST" action="{{route('myuserstable.store')}}">
            ...
            <div class="inner-wrap">
				<label>user id <input type="text" name="id" value="" /></label>
            ...
            <div class="inner-wrap">
                <label>Email Address <input type="email" name="email" value="" /></label>
				<label>Phone Number <input type="text" name="mobile" value="" /></label>
